        ...
        >
          ...
          <div className="mt-6 flex flex-wrap gap-6">
            <a
              ...
              className="min-w-32 cursor-pointer rounded-lg bg-[#18F2E5] px-[18px] py-[10px] text-center text-base font-medium text-[#00071E] hover:bg-[#18F2E5CC] hover:text-white active:scale-95"
              data-aos="fade-up"
            >
              Get In Touch
            </a>
